...
#Exercice 2.3 Question 2 

def f_autre(n1 : float, n2 : float, n3 : float) -> str:
    """Précondition : n1 != n2 and n2 != n3 and n3 != n1
    retourne un cas parmi 6 selon les valeurs de n1, n2 et n3.
    """
    if n1 < n2 < n3:
...
assert f_autre(2.3, 2.5, 2.7) == 'cas 1'
assert f_autre(7, 2, 5) == 'cas 4'
assert f_autre(6, 18, 4) == 'cas 5'
assert f_autre(9, 17, 15) == 'cas 2'
assert f_autre(1.3, 0.7, 3.7) == 'cas 3'
assert f_autre(9, 9, 9) == 'cas 6'